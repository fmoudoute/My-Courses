...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Gets the Json content from the google blogger api:
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCFcoJaqmx6LhZu0TsNFvo3Q6uSDoVodVY")!;
        ...
        let task = session.dataTaskWithURL(url) { (data, response, error) -> Void in
            ...
            if error != nil {
                ...
                if let data = data{
                    //print(NSString(data: data, encoding: NSUTF8StringEncoding)) //for testing
                    
                    //Convert json into an NSDictionary
                    do { let jsonResult = try NSJSONSerialization.JSONObjectWithData(data, options: NSJSONReadingOptions.MutableContainers) as! NSDictionary
                        ...
                        if jsonResult.count > 0 {
                            ...
                            if let items = jsonResult["items"] as? NSArray {
                                ...
                                //Deletes anything that is saved in core data
                                ...
                                //Loop through all the items and extract out
                                for item in items {
